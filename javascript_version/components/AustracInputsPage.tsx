        ...
        {userAustracContent.length === 0 ? (
          ...
          <ul className="space-y-3">
            {userAustracContent.map(item => (
              <li key={item.id} className="bg-orange-50 p-4 rounded-lg flex justify-between items-start shadow-sm transition-all hover:bg-orange-100 border border-orange-200">
