...
export const RAG_CHUNK_SIZE = 1000; // Characters per chunk
export const RAG_CHUNK_OVERLAP = 200; // Characters overlap between chunks
export const RAG_MAX_KEYWORDS_PER_CHUNK = 10; // Max keywords AI should try to extract for a chunk (example)
export const RAG_TOP_K_CHUNKS_ANALYSIS = 10; // Max chunks to request from Vertex AI RAG for analysis context
export const RAG_TOP_K_CHUNKS_CHAT = 5;    // Max chunks to request from Vertex AI RAG for chat context
export const RAG_MIN_CHUNK_SIZE_FOR_KEYWORDS = 50; // Minimum char length of a chunk to attempt keyword extraction
export const RAG_TOP_K_CHUNKS_DEEP_DIVE_LEGISLATION = 7; // Max legislative chunks for deep dive
export const RAG_TOP_K_CHUNKS_DEEP_DIVE_COMPANY_DOC = 3; // Max self-reflection chunks for deep dive
...
// ANALYSIS_RESULT_KEY and PROCESSED_RAG_CHUNKS_KEY were found to be unused in App.tsx and are removed for clarity.
// export const ANALYSIS_RESULT_KEY = 'complianceAnalysisResult'; 
// export const PROCESSED_RAG_CHUNKS_KEY = 'complianceProcessedRagChunks';