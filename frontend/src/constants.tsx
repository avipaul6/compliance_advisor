  ...
  database: (className = "w-6 h-6") =>
    React.createElement("svg", {
      ...
      React.createElement("path", {
        strokeLinecap: "round",
        strokeLinejoin: "round",
        d: "M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375"
      })
    ),
  ...
  chatBubbleLeftRight: (className = "w-6 h-6") =>
    React.createElement("svg", { 
      ...
      React.createElement("path", { 
        strokeLinecap: "round", 
        strokeLinejoin: "round", 
        d: "M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a2.25 2.25 0 01-3.182 0l-3.72-3.72A2.25 2.25 0 013.75 14.894v-4.286c0-.97.616-1.813 1.5-2.097M16.5 7.5v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375v1.875m9 0h-9" 
      })
    ),
  ...
  cpuChip: (className = "w-6 h-6") =>
    React.createElement("svg", { 
      ...
      React.createElement("path", { 
        strokeLinecap: "round", 
        strokeLinejoin: "round", 
        d: "M8.25 3v1.5M4.5 8.25H3m18 0h-1.5M4.5 12H3m18 0h-1.5m-15 3.75H3m18 0h-1.5M8.25 21v-1.5M15.75 3v1.5m0 16.5v-1.5M12 5.25v-1.5m0 16.5v-1.5m-3.75-15h7.5a2.25 2.25 0 012.25 2.25v7.5a2.25 2.25 0 01-2.25-2.25h-7.5a2.25 2.25 0 01-2.25-2.25v-7.5A2.25 2.25 0 018.25 6z" 
      })
    ),
  cloudArrowUp: (className = "w-6 h-6") =>
    React.createElement("svg", { 
      ...
      React.createElement("path", { 
        strokeLinecap: "round", 
        strokeLinejoin: "round", 
        d: "M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M17.25 21H6.75a4.5 4.5 0 01-4.5-4.5V7.5a4.5 4.5 0 014.5-4.5h7.5a4.5 4.5 0 014.5 4.5v4.625a2.625 2.625 0 001.625 2.458" 
      })
    ),
  documentSearch: (className = "w-6 h-6") =>
    React.createElement("svg", { 
      xmlns: "http://www.w3.org/2000/svg", 
      fill: "none", 
      viewBox: "0 0 24 24", 
      ...
      React.createElement("path", { 
        strokeLinecap: "round", 
        strokeLinejoin: "round", 
        d: "M15.75 17.25l-2.06-2.06m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 008.494 10.004zM10.5 7.5H18m-7.5 3H18m-7.5 3H15M3 3h6l7.5 7.5M3 3v18h18" 
      })
    ),
...
export const SUMMARIZED_AUSTRAC_UPDATES_KEY = 'summarizedUserAustracUpdates';
